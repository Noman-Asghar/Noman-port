...
function RecentProjects() {
  return (
    <div className='py-20' id='projects'>
      ...
      <div className='project-cards flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
...
<div key={id} className='sm:h-[41rem] lg:min-h-[32.5rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
    <PinContainer title={link} href={link} >
      <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh]  mb-10'>
        <div className='relative w-full h-full overflow-hidden lg:rounded-3xl lg:h-[35vh] bg-[#13162d] flex justify-center'>
            <img src='./bg.png' alt='bg-img' />
       
        <img 
        src={img}
        alt={title}
        className='z-10 absolute top-[20px]'
        />
         </div>
      </div>
